...
try {
    ...
    $stmt = $pdo->prepare("UPDATE tbl_households 
                       SET household_lastname = ?,
                           household_firstname = ?,
...
$stmt->execute([$householdLastName, $householdFirstName, $householdMiddleName, $householdSuffix, $householdBirthdate, $householdAge, $householdSex, $pregnant, $lastPregnant, $noChildren, $barangay, $educAttainment, $schoolGraduated, $incomeSource, $employment, $householdLeader, $leaderRelation, $remarks, $householdId]);
