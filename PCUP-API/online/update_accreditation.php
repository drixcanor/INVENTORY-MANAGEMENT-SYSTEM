...
try {
    ...
    $stmt = $pdo->prepare("UPDATE tbl_accreditations 
    SET accreditation_name = ?,
        accreditation_barangay = ?,
        accreditation_address = ?,
        accreditation_contactperson = ?,
        accreditation_issued = ?,
        accreditation_expired = ?,
        accreditation_number = ?,
        accreditation_phone = ?,
        accreditation_president = ?,
        accreditation_area = ?,
        accreditation_class = ?,
        accreditation_programs = ?,
        accreditation_problems = ?,
        accreditation_coordinator = ?,
        accreditation_remarks = ?
    WHERE accreditation_id = ?");
    
$stmt->execute([$accreditation_name, 
$accreditation_barangay, 
$accreditation_address, 
$accreditation_contactperson, 
$accreditation_issued, 
